...
deviceDropdownValChanged();
  ...
  else
  {
    $.ajax({
    type: "GET",
    url: "motion_split_files_10_mins_window/DayWiseNormalized/" + currDevSel + "-CosineSimilarity.csv",
    dataType: "text",
  ...
  getDeviceAndDayData = function(deviceId, dateOrig, index, cosVal) {
    ...
    $.ajax({
      type: "GET",
      url: "motion_split_files_10_mins_window/inserted_missing_values/" + deviceId + "-motion-Normalized.csv",
      dataType: "text",
      success: function(data) {
        var allTextLines = data.split(/\r\n|\n/);
        for(var i=1; i < allTextLines.length; i++) {
